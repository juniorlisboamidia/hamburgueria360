...
export default function Faturamento() {
  ...
  return (
    <div>
      <div className="page-header">
        ...
        <div style={{ display: 'flex', gap: 8, alignItems: 'center', flexWrap: 'wrap' }}>
          <div style={{ display: 'inline-flex', alignItems: 'center', gap: 4 }}>
            ...
            <span style={{ fontSize: 14, fontWeight: 600, color: '#111', minWidth: 44, textAlign: 'center' }}>{ano}</span>
      ...
      {/* Abas: visão mensal (detalhe) e visão anual (central) */}
      <div className="modal-tabs" style={{ marginBottom: 14 }}>
        {[
          ...
          <button
            key={t.value}
            type="button"
            className={'modal-tab' + (aba === t.value ? ' active' : '')}
              ...
              <div className="form-grid-2" style={{ marginBottom: 0 }}>
                <div className="form-group" style={{ marginBottom: 0 }}>
                  ...
                  <input
                    ...
                    min="0"
                    step="0.01"
                    value={mesForm.valorTotal}
                    onChange={(e) => setMesForm({ ...mesForm, valorTotal: e.target.value })}
                    placeholder="0,00"
                    autoFocus
                  />
                </div>
            ...
            <form onSubmit={handleSalvarAno}>
              <div style={{ maxHeight: '52vh', overflowY: 'auto', paddingRight: 4 }}>
                ...
                {MESES_ANO.map((nomeMes, i) => (
                  ...
                  >
                    <div style={{ fontSize: 13, fontWeight: 500, color: '#333' }}>{nomeMes}</div>
                    <input
                      className="form-input"
                      ...
                      min="0"
                      step="0.01"
                      value={fillForm[i].valorTotal}
                      onChange={(e) => setFillCampo(i, 'valorTotal', e.target.value)}
                      placeholder="0,00"
                    />
                    <input
                      className="form-input"
              ...
              <table className="hb-table">
                ...
                <tbody>
                  {MESES_ANO.map((nomeMes, i) => {
                    ...
                    return (
                      <tr key={nomeMes}>
                        <td style={{ fontWeight: 500, color: m.semDados ? '#aaa' : '#111' }}>{nomeMes}</td>
                ...
                <tfoot>
                  <tr style={{ borderTop: '2px solid #eee' }}>
                    <td style={{ fontWeight: 700, color: '#111' }}>Total do ano</td>
