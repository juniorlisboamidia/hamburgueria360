        ...
        <>
          ...
          <div className="table-card">
            <table className="hb-table">
              ...
              <tbody>
                <tr>
                  <td style={{ fontWeight: 500, color: '#111' }}>Percentuais sobre faturamento</td>
                  <td className="clr-muted">—</td>
                  <td>{pct(dados.custosVariaveisPercentuais)}</td>
                </tr>
                <tr>
                  <td style={{ fontWeight: 500, color: '#111' }}>Soma por pedido</td>
                  <td>{brl(dados.somaCustosPorPedido)}</td>
                  <td className="clr-muted">por pedido</td>
                </tr>
                <tr>
                  <td style={{ fontWeight: 500, color: '#111' }}>Total por pedido no mês</td>
                  <td>{brl(dados.custoVariavelPedidosTotal)}</td>
                  <td>{pct(dados.percentualCustosPorPedido)}</td>
                </tr>
                <tr>
                  <td style={{ fontWeight: 500, color: '#111' }}>Fixos mensais variáveis</td>
