...
export default function Dashboard() {
  ...
  function load() {
    ...
    const dashboardCall = api.get('/dashboard', { params: { mes: MES } })
  ...
  if (loading) {
    return <div className="loading-state">Carregando indicadores…</div>
  }
  ...
  return (
    <div>
      ...
      {/* FINANCEIRO DO MÊS */}
      <div className="section-title">Financeiro do Mês</div>
